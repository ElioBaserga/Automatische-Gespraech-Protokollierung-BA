...
st.title("KESB Protokollierungs-Assistent")
...
llm_choice = st.selectbox("Wähle das Sprachmodell:", ["GPT-4o-mini", "Meta Llama 3 8B", "DeepSeek R1", "Gemma 4"])
            ...
            with st.spinner(""):
                ...
                def ask_llm(transcript: str, question: str, api_key: str, choice: str) -> str:
                    ...
                    if choice == "GPT-4o-mini":
                        ...
                        # Gemma 4 Integration über Ollama
                        client = OpenAI(base_url="http://localhost:11434/v1", api_key="ollama")
                        model_name = "gemma4"
                    ...
                    Beantworte bitte die folgenden Fragen jeweils mit einem ausführlichen Satz mit 20 - 30 Wörtern, 
                    ausser wenn die Antwort künstlich verlängert werden muss, darf sie kürzer sein.\n\n
                    Beantworte ausschliesslich diese Fragen: {question}\n\n
                    ...
                    for versuch in range(3):
                        try:
                            response = client.chat.completions.create(
                                ...
                                messages=[
                                    {"role": "system", "content": "Du bist ein Assistent, der Fragen zu Audio-Transkripten, welche dir übergeben wurden, beantwortet und ausschließlich JSON ausgibt."},
